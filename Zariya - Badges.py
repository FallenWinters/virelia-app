...
def assign_badge(count):
    if count >= 10: return "gold badge: signed 10 petitions"
    elif count >= 5: return "silver badge: signed 5 petitions"
    elif count >= 1: return "bronze badge: signed 1 petition"
